...
const Comments = () => {
  ...
  return (
    <div className='flex-1 pt-5 px-5 sm:pt-12 sm:pl-16 bg-blue-50/50'>
      <div className='flex justify-between items-center max-e-3xl'>
        <h1>Comments</h1>
        ...
        <table className='w-full text-sm text-gray-500'>
          <thead className='text-xs text-gray-700 text-left uppercase'>
            <tr>
              ...
              <th scope='col' className='px-6 py-3 max-sm:hidden'>Action</th>
            </tr>
          </thead>
          <tbody>
            ...
            }).map((comment,index)=><CommentsTable key={comment._id} comment={comment} index={index+1} fetchComments={fetchComments}/>)}
          </tbody>
        </table>
      </div>
    </div>
